...
### Dimension 1: Impact Potential and Innovation

Question:

- How much would this matter for AI safety if it worked?
...
### Dimension 3: Presentation and Clarity
...
- a project title and brief abstract of at most 150 words
- author names and affiliations for all team members
- indication of which regional track and sub-track the project addresses

Important required section:
...
Most winning projects are around 4-8 pages.
...
- Individual and team submissions are both allowed.
- Existing work is allowed, but the new work done during the hackathon must be clearly identified.
- Reports can be in English, Spanish, or Portuguese. English is preferred if comfortable.
- Submission is through the official form on the hackathon page.
- Better to submit something incomplete than not submit at all.
...
- evidence of novelty beyond simple replication
- rigorous but manageable methodology
- interpretable quantitative findings
- strong communication

The rubric does not reward:

- vague product demos
- giant scope with weak evidence
- unclear delta over prior work
- polished prose with weak methodology
